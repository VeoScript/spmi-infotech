  ...
  return (
    <div className="flex flex-col w-full space-y-2 py-2">
      <div className="flex flex-row items-center justify-between w-full px-2 py-2">
        <h1 className="font-bold text-base text-lavender-black text-opacity-80">Daily Consultations</h1>
        <div className="flex flex-row items-center w-full max-w-xs p-2 space-x-2 text-sm bg-lavender-white border border-lavender-black border-opacity-20 focus-within:border-lavender-light">
          <FiSearch className="text-base text-lavender-black text-opacity-50" />
          <input type="text" placeholder="Search Issue" className="w-full bg-transparent outline-none" />
        </div>
        <h1 className="font-bold text-base text-lavender-black text-opacity-80">September 13, 1998</h1>
      </div>
      <Link href="/">
        <a className="flex flex-col w-full h-full px-2 space-y-2">
          <div className="flex flex-row items-center w-full h-full py-3 border border-lavender-black border-opacity-20 space-x-3 transition ease-in-out duration-300 hover:bg-lavender-dark hover:bg-opacity-10">
            <div className="flex flex-col w-full max-w-full px-3 py-2 space-y-2">
              ...
              <div className="flex flex-col w-full space-y-2">
                <div className="flex flex-row items-center space-x-2">
                  <h1 className="font-normal text-xs text-lavender-black">Resolution Made: </h1>
